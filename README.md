...
1. Removing the gray area, we used the UI in Xcode to help us set the property
2. Instead of placing the image, we pass the URL

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://imgur.com/a/jF8eN' title='Video Walkthrough' width='' alt='Video Walkthrough' />
